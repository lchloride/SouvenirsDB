...
INSERT INTO `user` VALUES ('#00000001','Alice','123456','\\#00000001\\daily life\\heixian.gif','2016-12-15 09:55:28',10,10);
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `souvenirs`.`user_AFTER_DELETE` AFTER DELETE ON `user` FOR EACH ROW
BEGIN
declare x int;
